...
class SiteOrigin_Widgets_Bundle {
	...
	/**
	 * Deletes any CSS generated by/for the widgets. Can either be called directly on the `SiteOrigin_Widgets_Bundle`
	 * singleton class, or by adding the 'siteorigin_widgets_is_new_version' filter to indicate that a plugin has been
	 * updated and necessary plugin update code (including this function) needs to be called.
	 *
	 */
