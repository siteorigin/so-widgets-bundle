	...
	public function __construct( $base_name, $element_id, $element_name, $field_options, SiteOrigin_Widget $for_widget, $parent_container = array() ) {
		...
		$this->fields = array(
			...
			'additional' => array(
				...
				'description' => __( 'Additional query arguments. See <a href="http://codex.wordpress.org/Function_Reference/query_posts" target="_blank" rel="noopener">query_posts</a>.', 'so-widgets-bundle' ),
			),
		);
	}
