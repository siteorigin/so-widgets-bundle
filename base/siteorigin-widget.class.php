...
abstract class SiteOrigin_Widget extends WP_Widget {
	...
	public function form( $instance, $form_type = 'widget' ) {
		...
		<?php if( !empty( $this->widget_options['help'] ) ) : ?>
			<a href="<?php echo sow_esc_url($this->widget_options['help']) ?>" class="siteorigin-widget-help-link siteorigin-panels-help-link" target="_blank" rel="noopener"><?php _e('Help', 'so-widgets-bundle') ?></a>
		<?php endif; ?>
