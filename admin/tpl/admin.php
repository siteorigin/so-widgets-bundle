<div class="wrap" id="sow-widgets-page">
					...
					<div class="so-widget-text">
						...
						<?php if( !empty( $widget['Author'] ) ) : ?>
							<div class="so-widget-byline">
								...
								<strong>
								<?php
									if( !empty($widget['AuthorURI']) ) echo '<a href="' . esc_url( $widget['AuthorURI'] ) . '" target="_blank" rel="noopener">';
	...
	<div class="developers-link">
		...
		<a href="https://siteorigin.com/docs/widgets-bundle/" target="_blank" rel="noopener"><?php _e('Read More', 'so-widgets-bundle') ?></a>.
	</div>
