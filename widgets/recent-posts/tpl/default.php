		...
		while( $query->have_posts() ) {
			...
			<li class="sow-recent-posts-item">
				<div class="sow-recent-posts-item-inner">
					...
					<?php SiteOrigin_Widget_Recent_Posts_Widget::featured_image( $recent_settings ); ?>

					<div class="sow-recent-posts-item-hgroup">
						<?php
						SiteOrigin_Widget_Recent_Posts_Widget::post_title( $recent_settings );
						SiteOrigin_Widget_Recent_Posts_Widget::post_date( $recent_settings );
						SiteOrigin_Widget_Recent_Posts_Widget::content( $recent_settings );
						SiteOrigin_Widget_Recent_Posts_Widget::read_more( $recent_settings );
						?>
					</div>
