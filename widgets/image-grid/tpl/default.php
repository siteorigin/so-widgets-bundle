...
<?php if( ! empty( $images ) ) : ?>
	<div class="sow-image-grid-wrapper"
		...
		<?php foreach( $images as $image ) : ?>
			...
			<?php if ( ! empty( $image['url'] ) ) : ?><a href="<?php echo sow_esc_url( $image['url'] ) ?>" <?php foreach( $image['link_attributes'] as $att => $val ) if ( ! empty( $val ) ) : echo $att.'="' . esc_attr( $val ) . '" '; endif; ?>><?php endif; ?>
