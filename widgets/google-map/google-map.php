		...
		return array(
			'map_center'      => array(
				...
				'description' => sprintf(
					...
					'<a href="https://console.developers.google.com/apis/dashboard?project=_" target="_blank" rel="noopener">',
					'</a>'
				),
			),
			...
			'styles'          => array(
				...
				'fields'      => array(
					...
					'raw_json_map_styles' => array(
						...
						'description' => __( 'Copy and paste predefined styles here from <a href="http://snazzymaps.com/" target="_blank" rel="noopener">Snazzy Maps</a>.', 'so-widgets-bundle' )
					),
