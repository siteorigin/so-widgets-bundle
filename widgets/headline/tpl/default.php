			...
			case 'headline' :
				if( !empty( $headline ) ) {
					...
					if( !empty( $headline_destination_url ) ): ?>
						<a href="<?php echo sow_esc_url( $headline_destination_url ) ?>" <?php echo $headline_new_window ? 'target="_blank" rel="noopener"' : '' ?>>
					<?php
					endif;
			...
			case 'sub_headline' :
				if( !empty( $sub_headline ) ) {
					...
					if( !empty( $sub_headline_destination_url ) ): ?>
						<a href="<?php echo sow_esc_url( $sub_headline_destination_url ) ?>" <?php echo $sub_headline_new_window ? 'target="_blank" rel="noopener"' : '' ?>>
					<?php
					endif;
